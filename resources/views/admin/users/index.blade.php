<x-admin-layout>
    ...
    <div class="py-4 lg:py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            @if(session('success'))
                <div class="bg-green-50 border-l-4 border-green-500 p-4 mb-4 lg:mb-6 rounded">
                    <div class="flex">
                ...
                <div class="p-4 lg:p-6">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <button onclick="document.getElementById('addUserModal').classList.remove('hidden')" 
                            class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition flex items-center gap-2 justify-center whitespace-nowrap">
