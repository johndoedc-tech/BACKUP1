...
<aside class="w-64 flex flex-col h-screen fixed left-0 top-0 z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0" style="background-color: #355872;" :class="{ '-translate-x-full': !open, 'translate-x-0': open }">
    ...
    <div class="p-4 lg:p-6 border-b border-primary-700/30">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('profile.edit') }}" class="bg-black/20 border border-white/20 w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center flex-shrink-0 shadow-sm hover:bg-black/30 transition-colors">
    ...
    <!-- Navigation Links -->
    <nav class="flex-1 p-3 lg:p-4 space-y-1 overflow-y-auto sidebar-scrollbar">
        <!-- Main Section -->
    ...
    <!-- Settings & Logout -->
    <div class="border-t border-white/10 p-3 lg:p-4 space-y-1">
