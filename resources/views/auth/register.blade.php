    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <div class="relative mt-1">
                ...
                <x-text-input id="password_confirmation" class="block w-full pl-10 rounded-xl border-gray-200 bg-gray-50 focus:bg-white focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 text-sm py-2.5 sm:py-3 transition-colors"
                                type="password"
